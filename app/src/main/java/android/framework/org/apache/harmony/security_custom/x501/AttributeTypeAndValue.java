...
package android.framework.org.apache.harmony.security_custom.x501;
...
import android.framework.org.apache.harmony.security_custom.asn1.ASN1Constants;
...
import android.framework.org.apache.harmony.security_custom.asn1.ASN1StringType;
...
import android.framework.org.apache.harmony.security_custom.asn1.BerOutputStream;
import android.framework.org.apache.harmony.security_custom.utils.ObjectIdentifier;
...
public final class AttributeTypeAndValue {
    ...
    public AttributeTypeAndValue(String sOid, AttributeValue value) throws IOException {
        if (sOid.charAt(0) >= '0' && sOid.charAt(0) <= '9') {
            int[] array = android.framework.org.apache.harmony.security_custom.asn1.ObjectIdentifier.toIntArray(sOid);
        ...
        public void setEncodingContent(BerOutputStream out) {
            ...
            if (av.encoded != null) {
                ...
                if (av.getTag() == ASN1Constants.TAG_UTF8STRING) {
                    ...
                    av.bytes = av.rawString.getBytes(Charset.forName("UTF-8"));
